...
import type {
  ...
  LiveUserPresenceUpsertTestFeedsTestPostData,
  CleanupAllSeedLiveUsersData,
  CleanupAllSeedLiveUsersResponse,
  SeedLiveUsersData,
  SeedLiveUsersError,
  SeedLiveUsersResponse2,
  CleanupSeedLiveUsersData,
  CleanupSeedLiveUsersError,
  CleanupSeedLiveUsersResponse,
  GetLiveUsersData,
  CountLiveUsersData,
  GetSingleFeedData,
  GoLiveData,
...
export const liveUserPresenceUpsertTestFeedsTestPostQueryKey = (
  options?: Options<LiveUserPresenceUpsertTestFeedsTestPostData>,
) => createQueryKey('liveUserPresenceUpsertTestFeedsTestPost', options);

/**
 * Live User Presence Upsert Test
 * Test endpoint to populate live users for specific feeds in batches
 */
export const liveUserPresenceUpsertTestFeedsTestPostOptions = (
  options?: Options<LiveUserPresenceUpsertTestFeedsTestPostData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Test endpoint to populate live users for specific feeds in batches
 */
export const liveUserPresenceUpsertTestFeedsTestPostMutation = (
  options?: Partial<Options<LiveUserPresenceUpsertTestFeedsTestPostData>>,
): UseMutationOptions<
  unknown,
  AxiosError<DefaultError>,
  Options<LiveUserPresenceUpsertTestFeedsTestPostData>
> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    AxiosError<DefaultError>,
 ...
 */
export const cleanupAllSeedLiveUsersMutation = (
  options?: Partial<Options<CleanupAllSeedLiveUsersData>>,
): UseMutationOptions<
  CleanupAllSeedLiveUsersResponse,
  AxiosError<DefaultError>,
  Options<CleanupAllSeedLiveUsersData>
> => {
  const mutationOptions: UseMutationOptions<
    CleanupAllSeedLiveUsersResponse,
    AxiosError<DefaultError>,
...
export const seedLiveUsersQueryKey = (options: Options<SeedLiveUsersData>) =>
  createQueryKey('seedLiveUsers', options);
 ...
 * If no feed_ids are provided, uses all feeds with hidden: true.
 */
export const seedLiveUsersMutation = (
  options?: Partial<Options<SeedLiveUsersData>>,
): UseMutationOptions<
  SeedLiveUsersResponse2,
  AxiosError<SeedLiveUsersError>,
  Options<SeedLiveUsersData>
> => {
  const mutationOptions: UseMutationOptions<
    SeedLiveUsersResponse2,
    AxiosError<SeedLiveUsersError>,
 ...
 */
export const cleanupSeedLiveUsersMutation = (
  options?: Partial<Options<CleanupSeedLiveUsersData>>,
): UseMutationOptions<
  CleanupSeedLiveUsersResponse,
  AxiosError<CleanupSeedLiveUsersError>,
  Options<CleanupSeedLiveUsersData>
> => {
  const mutationOptions: UseMutationOptions<
    CleanupSeedLiveUsersResponse,
    AxiosError<CleanupSeedLiveUsersError>,
