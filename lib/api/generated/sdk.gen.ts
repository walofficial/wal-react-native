...
import type {
  ...
  LiveUserPresenceUpsertTestFeedsTestPostResponses,
  LiveUserPresenceUpsertTestFeedsTestPostErrors,
  CleanupAllSeedLiveUsersData,
  CleanupAllSeedLiveUsersResponses,
  CleanupAllSeedLiveUsersErrors,
  SeedLiveUsersData,
  SeedLiveUsersResponses,
  SeedLiveUsersErrors,
  CleanupSeedLiveUsersData,
  CleanupSeedLiveUsersResponses,
  CleanupSeedLiveUsersErrors,
  GetLiveUsersData,
 ...
 */
export const liveUserPresenceUpsertTestFeedsTestPost = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<LiveUserPresenceUpsertTestFeedsTestPostData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).post<
    LiveUserPresenceUpsertTestFeedsTestPostResponses,
    LiveUserPresenceUpsertTestFeedsTestPostErrors,
 ...
 */
export const cleanupAllSeedLiveUsers = <ThrowOnError extends boolean = false>(
  options?: Options<CleanupAllSeedLiveUsersData, ThrowOnError>,
) => {
 ...
 */
export const seedLiveUsers = <ThrowOnError extends boolean = false>(
  options: Options<SeedLiveUsersData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    SeedLiveUsersResponses,
    SeedLiveUsersErrors,
 ...
 */
export const cleanupSeedLiveUsers = <ThrowOnError extends boolean = false>(
  options: Options<CleanupSeedLiveUsersData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    CleanupSeedLiveUsersResponses,
    CleanupSeedLiveUsersErrors,
