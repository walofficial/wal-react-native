// Ported verbatim from targets/notification-service/NotificationService.swift (RN app, @bacons/apple-targets).
// Behaviour is identical: communication-notification upgrade via INSendMessageIntent + rich image attachment.
