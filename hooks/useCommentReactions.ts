...
export const useAddReaction = (
    ...
    return useMutation({
        ...
        onMutate: async (variables) => {
            ...
            await queryClient.cancelQueries({ queryKey: commnetsListOptions.queryKey });
                ...
                (oldData) => {
                    ...
                    return {
                        ...
                        pages: oldData.pages.map((page) => {
                            ...
                            return {
                                ...page,
                                comments: page.comments.map((commentResponse: CommentResponse) => {
                                    if (
                                        ...
                                        const newReactionType = variables.body.reaction_type as ReactionType;
                                        ...
                                        if (oldReactionType) {
                                            const oldKey = oldReactionType as keyof ReactionsSummary;
        ...
        onError: (error, variables, context) => {
            ...
            if (context?.previousComments) {
                queryClient.setQueryData(commnetsListOptions.queryKey, context.previousComments);
            }
        },
        onSettled: () => {
...
export const useRemoveReaction = (
    ...
    return useMutation({
        ...removeReactionMutation(),
        onMutate: async (variables) => {
            await queryClient.cancelQueries({ queryKey: commentsListOptions.queryKey });
            const previousComments = queryClient.getQueryData<
                InfiniteData<GetVerificationCommentsResponse>
        ...
        onError: (error, variables, context) => {
            if (context?.previousComments) {
                queryClient.setQueryData(commentsListOptions.queryKey, context.previousComments);
            }
        },
        onSettled: () => {
